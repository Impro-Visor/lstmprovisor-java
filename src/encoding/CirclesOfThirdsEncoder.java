...
/**
 * Class CirclesOfThirdsEncoder describes encoding notes using a method
 * described in Judy Franklin's paper on lstm-improvised music
 *
...
public class CirclesOfThirdsEncoder implements NoteEncoder {
    ...
    {
        return input.get(restIndex) == 1.0;
    }
