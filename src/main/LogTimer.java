...
/**
 * Class LogTimer handles printing messages to System.out that have a time step
 * attached, as well as providing functionality for nested timing of code
...
public class LogTimer {
    ...
    public static Stack<Long> startLogTimes = new Stack<>(); //our stack of logTimes
    ...
    /**
     * Prints a normal log message with the current time in seconds since the
     * last call to initStartTime
     *
     * @param message
     */
