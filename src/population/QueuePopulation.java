...
/**
 * The queue population will herd amongst the grasses of its ancestors, rise
 * from earthly dew and up the mountains, through the chasms serenaded by
 * rivers, around the rings of latitude with the attitude to evolve, prosper,
 * vibrantly explode into jazz! Razzle dazzle dazzle razzle!
 *
 * @author cssummer16
 */
